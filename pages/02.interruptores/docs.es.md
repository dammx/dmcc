...
|  |  |
|:-------------|:-------------:|
| <p>[**Conmutador Shelly 1...**](https://amzn.to/2Lunn5V)</p><p>Transformar un hogar o una oficina en inteligente<br /> no requiere de complejas instalaciones.<br />Interruptor de relé<br /> Wi-Fi **_Shelly1_**, que con sus compactas<br /> dimensiones 41x36x17 mm el instalador<br /> podrá acoplarlo detrás de cualquier contacto<br />  de alimentación, interruptor de luz estándar,<br /> o directamente en una caja de DIN<br /> en la caja de electricidad. </p><p> | <div> ![200x200][amzn-shelly1] <a href="https://amzn.to/2Lunn5V" alt="amazon-link" target="_blank"><button type="button" style="color:#fff;background-color:#1694CA;width:100%;height:35px;"><i class="fa fa-amazon">mazon</i></button></a> |
[/ui-accordion-item]
