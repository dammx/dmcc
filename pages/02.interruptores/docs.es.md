...
|  |  |
|:------|:-----------------------:|
| <p>[**Sonoff T1 WiFi Touch 2 Gang...**](http://s.click.aliexpress.com/e/bQ01Ojfi)</p><p>**Encendido / apagado remoto**: enciende/apaga las luces desde cualquier lugar.</p><p>**Soporte de aplicaciones**: Aplicación móvil gratuita _iOS_ y _Android_ **_eWeLink_**.</p><p> **Control independiente**: controla cada grupo por separado. </p><p>**Timers** para encender/apagar a la hora especificada.</p> <p>**Control compartido**: controle su casa inteligente junto con su familia. </p><p>**Compatibilidad**: _Amazon Alexa_, _Asist. de Google_.</p>| <div> ![img-500crop][amzn-touch1] </div> <div> <a href="https://amzn.to/2Jp3Gtp" alt="amazon-link" target="_blank"><button type="button" style="color:#fff;background-color:#1694CA;width:100%;height:35px;"><i class="fa fa-amazon fa-lg">mazon</i></button></a> </div> <button type="button" style="color:#transparent;background-color:transparent;opacity:0.9;width:96%;height:0px;"> <div> <a href="http://s.click.aliexpress.com/e/bQ01Ojfi" alt="AlieExpress-link" target="_blank"> <button type="button" style="color:#fff;background-color:#e8a100;width:100%;height:35px;"><i class="fa fa-shopping-cart  fa-lg"> AliExpress</i></button></a> </div> |
