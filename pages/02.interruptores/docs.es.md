...
|  |  |
|:------|:-----------------------:|
| <p>[**Sonoff Smart Wi-Fi Interruptor de luz táctil ...**](https://amzn.to/2J8kDsY)</p><p>Controle sus electrodomésticos o dispositivos eléctricos en<br />cualquier momento y en cualquier lugar. </p><p>Donde quiera que<br />esté y siempre que desee encender/apagar sus electrodo-<br />mésticos o dispositivos eléctricos, no necesita estar allí o la<br />ayuda de los demás, solo necesita tocar ligeramente<br /> el botón ON/OFF en la aplicación **_Ewelink_**.</p><p>Los dispositivos conectados se encenderán o apagarán<br /> automáticamente. La aplicación inteligente **_Ewelink_** es<br /> compatible con _smartphones_ o _tablets_ con _Android_ e _IOS_.</p> | <div> ![img-500crop][amzn-touch2] </div> <div> <a href="https://amzn.to/2J8kDsY" alt="amazon-link" target="_blank"><button type="button" style="color:#fff;background-color:#1694CA;width:100%;height:35px;"><i class="fa fa-amazon fa-lg">mazon</i></button></a> </div> <button type="button" style="color:#transparent;background-color:transparent;opacity:0.9;width:96%;height:0px;"> <div> <a href="http://s.click.aliexpress.com/e/ERgGkIy" alt="AlieExpress-link" target="_blank"> <button type="button" style="color:#fff;background-color:#e8a100;width:100%;height:35px;"><i class="fa fa-shopping-cart  fa-lg"> AliExpress</i></button></a> </div> |
...
|  |  |
|:-------------|:-------------:|
| <p>[**Sonoff T1 WiFi Touch 2 Gang...**](http://s.click.aliexpress.com/e/bQ01Ojfi)</p><p>**Encendido / apagado remoto**: enciende/apaga las luces<br />desde cualquier lugar.<br /> **Soporte de aplicaciones**: Aplicación móvil gratuita<br />_iOS_ y _Android_ **_eWeLink_**.<br /> **Control independiente**: controla cada grupo por separado.<br />**Timers** para encender/apagar a la hora especificada.<br /> **Control compartido**: controle su casa inteligente junto<br />con su familia.<br /> **Compatibilidad**: _Amazon Alexa_, _Asist. de Google_.</p> | <div> ![200x200][amzn-touch1] <a href="https://amzn.to/2Jp3Gtp" alt="amazon-link" target="_blank"><button type="button" style="color:#fff;background-color:#1694CA;width:43%;height:35px;"><i class="fa fa-amazon">mazon</i></button></a> <a href="http://s.click.aliexpress.com/e/bQ01Ojfi" alt="AlieExpress-link" target="_blank"><button type="button" style="color:#fff;background-color:#e8a100;width:55%;height:35px;"><i class="fa fa-shopping-cart"> AliExpress</i></button></a> </div>|
[/ui-accordion-item]

[ui-accordion-item title="Sonoff 3 Gang WiFi | Amazon » 23,75€ -  Aliexpress » 19,08€ "]
|  |  |
|:-------------|:-------------:|
| <p>[**Sonoff 3 Gang WiFi...**](http://s.click.aliexpress.com/e/LenLi2c)</p><p>Mismo dispositivo que el anterior con **3 pulsadores para<br /> controlar 3 puntos de luz** desde el mismo componente.<br />**Encendido / apagado remoto**: enciende/apaga las luces<br />desde cualquier lugar.<br /> **Soporte de aplicaciones**: Aplicación móvil gratuita<br />_iOS_ y _Android_ **_eWeLink_**.<br /> **Control independiente**: controla cada grupo por separado.<br />**Timers** para encender/apagar a la hora especificada.<br /> **Control compartido**: controle su casa inteligente junto<br />con su familia.<br /> **Compatibilidad**: _Amazon Alexa_, _Asist. de Google_, _IFTTT_.</p> | <div> ![200x200][amzn-touch3] <a href="https://amzn.to/2LE8r5o" alt="amazon-link" target="_blank"><button type="button" style="color:#fff;background-color:#1694CA;width:43%;height:35px;"><i class="fa fa-amazon">mazon</i></button></a> <a href="http://s.click.aliexpress.com/e/LenLi2c" alt="AlieExpress-link" target="_blank"><button type="button" style="color:#fff;background-color:#e8a100;width:55%;height:35px;"><i class="fa fa-shopping-cart"> AliExpress</i></button></a> </div> |
[/ui-accordion-item]
...
|  |  |
|:-------------|:-------------:|
| <p>[**Interruptor Cortina o Persianas WiFi...**](https://amzn.to/2JqiQ1O)</p><p>El interruptor de cortina Wifi puede funcionar con cortinas<br /> inteligentes, puertas eléctricas, puertas de garaje inteligen-<br />tes y otros aparatos. El método de instalación se puede<br />instalar en tan solo unos minutos como el interruptor ciego<br />tradicional (Este interruptor táctil wifi necesita conectarse<br /> con un cable neutro). Aplicación **_eWelink_**</p> | <div> ![200x200][amzn-persiana] <a href="https://amzn.to/2JqiQ1O" alt="amazon-link" target="_blank"><button type="button" style="color:#fff;background-color:#1694CA;width:100%;height:35px;"><i class="fa fa-amazon">mazon</i></button></a> |
[/ui-accordion-item]
