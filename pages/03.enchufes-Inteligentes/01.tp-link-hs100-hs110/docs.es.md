...
<button type="button" class="btn btn-primary"><i class="fa fa-amazon"></i>mazon!<br />± 07 días!</button>
<button type="button" class="btn btn-warning"><i class="fa fa-amazon">liExpress</i><br />± 21 días!</button>
