...
<button type="button" class="btn btn-primary">Ver en <i class="fa fa-amazon"></i>mazon!</button> <button type="button" class="btn btn-warning">Ver en <i class="fa fa-amazon">liExpress</i></button>
