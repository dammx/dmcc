...
#### **Con 1 (UNO) solo parrafo (justificado) SIN SALTOS DE LÍNEA e imagen MAS forzada a 600px + customCSS a 600 (width)**: NOTAR QUE LA IMAGEN NO AUMENTA DE TAMAÑO CON TEXTO EN UN SOLO PARRAFO.
...
#### **Con 2 (DOS) párrafos (justificado) e imagen MAS forzada a 600px + customCSS a 600 (width)**: NOTAR QUE LA IMAGEN NO AUMENTA DE TAMAÑO CON TEXTO EN UN SOLO PARRAFO.
