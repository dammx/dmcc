...
#### **Con parrafo (justificado) e imagen forzada a 500px + customCSS (width)**:
...
[amzn-iraza2]: user://pages/03.enchufes-Inteligentes/02.regletas-wifi/iraza.png?lightbox=1024&cropResize=500,500
